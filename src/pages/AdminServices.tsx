...
export const AdminServices = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (type === 'number') {
      setCurrentServico({ ...currentServico, [name]: parseFloat(value) });
    } else if (type === 'checkbox') {
      setCurrentServico({ ...currentServico, [name]: checked });
    } else {
      setCurrentServico({ ...currentServico, [name]: value });
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Adicione, edite ou remova serviços oferecidos pela Studio Barber 33
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-6">Serviços Disponíveis</h2>
          {servicos.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {servicos.map(servico => (
                <ServiceCard
                  ...
                  servico={servico}
                  isAdminView={true}
                  onEdit={() => handleOpenModal(true, servico)}
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="ativo" className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                    <input type="checkbox" id="ativo" name="ativo" checked={currentServico.ativo} onChange={handleInputChange} />
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button type="submit" disabled={submitting} className="bg-amber-500 text-black px-4 py-2 rounded font-medium hover:bg-amber-600 disabled:opacity-50">
